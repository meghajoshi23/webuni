...
public partial class BuyNow : System.Web.UI.Page
{
    ...
    {
        payLabel2.Text = Request.QueryString["price"].ToString();
        Random random = new Random();
        txnid.Value = (Convert.ToString(random.Next(10000, 20000)));
        txnid.Value = "Megha" + txnid.Value.ToString();
        Response.Write(txnid.Value.ToString());
    }

    protected void payButton2_Click(object sender, EventArgs e)
    {
        Double amount = Convert.ToDouble(payLabel2.Text);

        String text = key.Value.ToString() + "|" + txnid.Value.ToString() + "|" + amount + "|" + "course java" + "|" + TextBox1.Text + "|" + TextBox2.Text + "|" + "1" + "|" + "1" + "|" + "1" + "|" + "1" + "|" + "1" + "||||||" + salt.Value.ToString();
        //Response.Write(text);
        ...
        data.Add("productinfo", "course java");
        data.Add("udf1", "1");
        data.Add("udf2", "1");
        data.Add("udf3", "1");
        data.Add("udf4", "1");
        ...
        data.Add("surl", "http://localhost:59573/failurePayment.aspx");
        data.Add("furl", "http://localhost:59573/successPayment.aspx");
