<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="courses.aspx.cs" Inherits="webuni_courses" %>
...
<body>
    ...
    <div class="container">
			<div class="section-title mb-0">
				...
				<p>These are the featured Courses that contains Theory part.</p>
			</div>
		</div>
					...
					<div class="course-item">
						...
						<div class="course-info">
							<div class="course-text">
								<h5>Art & Crafts</h5>
								<p>Best Art ans crafts courses</p>
                                <a href="featuredcourses.aspx">Read</a>
